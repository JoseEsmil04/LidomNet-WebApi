...
namespace LidomNet.Api.Controllers
{
    ...
    public class PartidosController : ControllerBase
    {
        ...
        [HttpPost("create")]
        public async Task<IActionResult> CreateMatch([FromBody] Partido partido)
        {
            ...
            {
                return BadRequest("Debe proporcionar equipos y estadio válidos.");
            }

            _context.Partidos.Add(partido);
            await _context.SaveChangesAsync();

            return CreatedAtAction(nameof(GetMatch), new { id = partido.Id }, partido);
        }
